...
export default function AdminCMS() {
  ...
  if (loading)
    return <div className="p-20 text-center">Đang tải dữ liệu quản trị...</div>;
    ...
    <div className="mx-auto max-w-6xl px-4 py-12">
      <div className="mb-12">
        ...
        <p className="text-slate-500 font-medium">
          Chỉnh sửa nội dung và dữ liệu thực tế cho ứng dụng.
        </p>
      </div>
      ...
      <Tabs defaultValue="landing" className="space-y-8">
        <TabsList className="bg-slate-100 p-1 rounded-2xl h-auto">
          <TabsTrigger
            value="landing"
            className="rounded-xl px-8 py-3 data-[state=active]:bg-white data-[state=active]:shadow-sm font-bold gap-2"
          >
          ...
          <Card className="rounded-[40px] border-none shadow-xl p-8">
            ...
            <CardContent className="p-0 space-y-6">
              <div className="space-y-2">
                <label className="text-sm font-black uppercase text-slate-400">
                  Tiêu đề chính (Title)
                </label>
                <Input
                  value={landing.heroTitle}
                  onChange={(e) =>
                    setLanding({ ...landing, heroTitle: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setLanding({ ...landing, heroSubtitle: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setLanding({ ...landing, ctaText: e.target.value })
                  }
                  className="h-14 rounded-2xl border-slate-200"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-slate-100">
                <div className="space-y-2">
                  ...
                  <Input
                    value={landing.stats?.students}
                    onChange={(e) =>
                      setLanding({
                        ...landing,
                        stats: { ...landing.stats, students: e.target.value },
                      })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    value={landing.stats?.listening}
                    onChange={(e) =>
                      setLanding({
                        ...landing,
                        stats: { ...landing.stats, listening: e.target.value },
                      })
                    }
                    className="rounded-xl"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    value={landing.stats?.grammar}
                    onChange={(e) =>
                      setLanding({
                        ...landing,
                        stats: { ...landing.stats, grammar: e.target.value },
                      })
                    }
                    className="rounded-xl"
                  />
                ...
                {landing.testimonials?.map((t: any, i: number) => (
                  ...
                  >
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      />
                      <Input
                        placeholder="Điểm số/Thành tích"
                        value={t.score}
                        onChange={(e) => {
                          const newT = [...landing.testimonials];
              ...
              <div className="pt-6 border-t border-slate-100 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      value={landing.founder?.name}
                      onChange={(e) =>
                        setLanding({
                          ...landing,
                          founder: { ...landing.founder, name: e.target.value },
                        })
                      }
                      className="rounded-xl"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      value={landing.founder?.role}
                      onChange={(e) =>
                        setLanding({
                          ...landing,
                          founder: { ...landing.founder, role: e.target.value },
                        })
                      }
                      className="rounded-xl"
                    />
              ...
              <Button
                onClick={saveLanding}
                className="bg-blue-600 h-14 px-8 rounded-2xl font-black gap-2 shadow-lg shadow-blue-100"
              >
          ...
          <Card className="rounded-[40px] border-none shadow-xl p-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <Button
                ...
                variant="outline"
                className="rounded-xl h-12 gap-2 border-slate-200 font-bold"
              >
              ...
              {vocab.map((v, idx) => (
                ...
                >
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    onClick={() => setVocab(vocab.filter((i) => i.id !== v.id))}
                    className="absolute top-4 right-4 text-rose-500 hover:bg-rose-50 rounded-xl"
                  >
                    <Trash2 size={18} />
                  </Button>
                </div>
              ...
              {quiz.map((q, idx) => (
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-black uppercase text-slate-400">
                        Đáp án đúng (Phải khớp chính xác với một trong các lựa
                        chọn trên)
                      </label>
                      <Input
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    onClick={() => setQuiz(quiz.filter((i) => i.id !== q.id))}
                    className="absolute top-4 right-4 text-rose-500 hover:bg-rose-50 rounded-xl"
                  >
                    <Trash2 size={18} />
                  </Button>
